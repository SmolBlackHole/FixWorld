...
- Assembly-Identität: `Assembly-CSharp, Version=1.6.9676.17735, Culture=neutral, PublicKeyToken=null`
...
- Runtime für das Werkzeug: `.NET 10.0.9 x64`

## Reproduktion

Der einmalige Lauf wurde direkt mit ILSpy ausgeführt:
...
- Größe: `28.206.111` Byte
- Namespaces und Typen wurden in verschachtelten Ordnern erhalten.
- Die Ausgabe enthält keine von ILSpy erzeugten Marker für fehlgeschlagene Dekompilierung.
...
Metadaten abgeleitete Rekonstruktionsvorgabe, kein belastbarer Beleg dafür, dass
