...
namespace FixWorld.News
{
    ...
    internal class Dialog_UpdateFeaturesFiltered : Dialog_UpdateFeatures
    {
            ...
            : base(FilterOutIgnoredProviders(featureDefs, ignoredNewsProviders), ignoredNewsProviders)
        {
            ...
            filterButtonLabel = "FixWorld_features_filterBtn".Translate();
            allModsFilterLabel = "FixWorld_features_filterAllMods".Translate();
            currentFilterReadout = "FixWorld_features_filterStatus".Translate();
            dropdownEntryTemplate = "FixWorld_features_filterDropdownEntry".Translate();
            ignoredModLabelSuffix = "FixWorld_features_filterIgnoredModSuffix".Translate();
        ...
        private void DrawDevToolsMenuWidget(Rect titleRect, float widgetOffset, UpdateFeatureDef forDef)
        {
            ...
            var buttonTexture = FixWorldTextures.HLMenuIcon;
