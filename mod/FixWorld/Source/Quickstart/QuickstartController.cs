...
namespace FixWorld.Quickstart
{
	...
	public static class QuickstartController
	{
		...
		{
			FixWorldController.Logger.Message(
		...
		public static void InitiateSaveLoading()
		{
			...
			FixWorldController.Logger.Message("Quickstarter is loading saved game: " + saveName);
		...
		internal static void DrawDebugToolbarButton(WidgetRow widgets)
		{
			...
			if (widgets.ButtonIcon(FixWorldTextures.quickstartIcon, quickstartButtonTooltip))
			{
		...
		private static void RetrofitSettingWithLabel()
		{
			...
			handle.Title = "FixWorld_setting_quickstartSettings_label".Translate();
		}
		...
		private static void StatusBoxAbortRequestedHandler(bool abortAndDisable)
		{
			...
			FixWorldController.Logger.Warning("Quickstart aborted: Space key was pressed.");
			if (abortAndDisable)
			{
		...
		private static void InitiateQuickstart()
		{
			...
			{
				FixWorldController.Logger.Error("Quickstart aborted: " + e.Message);
			}
		}
		...
		private static void EnumerateMapSizes()
		{
			...
			{
				FixWorldController.Logger.Error("Could not reflect required field: Dialog_AdvancedGameConfig.MapSizes");
				return;
			}
			MapSizes.Clear();
