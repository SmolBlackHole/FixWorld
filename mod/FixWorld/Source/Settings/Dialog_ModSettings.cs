...
namespace FixWorld.Settings
{
	...
	public class Dialog_ModSettings : Window
	{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			Widgets.Label(titleRect, "FixWorld_settings_windowTitle".Translate());
			...
			if (Widgets.ButtonText(resetButtonRect, "FixWorld_settings_resetAll".Translate()))
			{
				ShowResetPrompt("FixWorld_settings_resetMod_prompt".Translate(currentPackName), currentPack.Handles);
			}
