...
#pragma warning restore 618
                    ...
                    {
                        FixWorldController.Logger.Error("Exception while calling SettingHandle.OnValueChanged. Handle name was: " +
        ...
        public override string StringValue
        {
            get
            {
                ...
                {
                    FixWorldController.Logger.Error("Failed to serialize setting \"{0}\" of type {1}. Setting value was reset. Exception was: {2}", Name, typeof(T).FullName, e);
                    try
                    {
                        Value = DefaultValue;
        ...
        private T CustomValueFromString(string stringValue)
        {
            ...
            {
                FixWorldController.Logger.Error("Failed to parse setting \"{0}\" as custom type {1}. Setting value was reset. Value was: \"{2}\". Exception was: {3}", Name, typeof(T).FullName, stringValue, e);
                throw;
            }
        }
