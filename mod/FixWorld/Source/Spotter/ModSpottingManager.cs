...
namespace FixWorld.Spotter
{
    /// <summary>
    /// Keeps track of mod packageIds that ever were loaded together with FixWorld
    ...
    public partial class ModSpottingManager : PersistentDataManager, IModSpotterDevActions
    {
        ...
        private readonly IModLogger logger = FixWorldController.Logger;
        ...
        /// <summary>
        /// Returns true if the provided mod packageId was at any time seen running together with FixWorld.
        /// </summary>
        /// <exception cref="ArgumentNullException">Throws on null packageId</exception>
        ...
        private void RunInspectPackageIdsBackgroundTask(IEnumerable<string> packageIds)
        {
            ...
            {
                FixWorldController.Logger.Error($"Error during {nameof(ModSpottingManager)} background task: {e}");
            }
        }
